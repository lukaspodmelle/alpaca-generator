...
// Init image parts list
const hair = [{
    text: "Default",
    src: "./img/hair/default.png"
},
{
    text: "Bang",
    src: "./img/hair/bang.png"
},
{
    text: "Curls",
    src: "./img/hair/curls.png"
},
{
    text: "Elegant",
    src: "./img/hair/elegant.png"
},
{
    text: "Fancy",
    src: "./img/hair/fancy.png"
},
{
    text: "Quiff",
    src: "./img/hair/quiff.png"
},
{
    text: "Short",
    src: "./img/hair/short.png"
}]
...
{
    text: "Star",
    src: "./img/eyes/star.png"
}]

const ears = [{
    text: "Default",
    src: "./img/ears/default.png"
},
{
    text: "Tilt Backward",
    src: "./img/ears/tilt-backward.png"
},
{
    text: "Tilt Forward",
    src: "./img/ears/tilt-forward.png"
}]

const leg = [{
    text: "Default",
    src: "./img/leg/default.png"
},
{
    text: "Bubble Tea",
    src: "./img/leg/bubble-tea.png"
},
{
    text: "Cookie",
    src: "./img/leg/cookie.png"
},
{
    text: "Game Console",
    src: "./img/leg/game-console.png"
},
{
    text: "Tilt Backward",
    src: "./img/leg/tilt-backward.png"
},
{
    text: "Tilt Forward",
    src: "./img/leg/tilt-forward.png"
}]

const mouth = [{
    text: "Default",
    src: "./img/mouth/default.png"
},
{
    text: "Astonished",
    src: "./img/mouth/astonished.png"
},
{
    text: "Eating",
    src: "./img/mouth/eating.png"
},
{
    text: "Laughing",
    src: "./img/mouth/laugh.png"
},
{
    text: "Tongue",
    src: "./img/mouth/tongue.png"
}]
...
const accessories = [{
    text: "None",
    src: "./img/accessories/empty.png"
},
{
    text: "Earings",
    src: "./img/accessories/earings.png"
},
{
    text: "Flower",
    src: "./img/accessories/flower.png"
},
{
    text: "Glasses",
    src: "./img/accessories/glasses.png"
},
{
    text: "Headphones",
    src: "./img/accessories/headphone.png"
}]
...
hairButton.addEventListener('click', () => {
    ...
    titleStyle.innerHTML = 'Choose Hair:'
})
earsButton.addEventListener('click', () => {
    renderButtons(ears)
    removeActive()
    earsButton.classList.add('active')
    titleStyle.innerHTML = 'Choose Ears:'
})
eyesButton.addEventListener('click', () => {
    renderButtons(eyes)
    removeActive()
    eyesButton.classList.add('active')
    titleStyle.innerHTML = 'Choose Eyes:'
})
mouthButton.addEventListener('click', () => {
    renderButtons(mouth)
    removeActive()
    mouthButton.classList.add('active')
    titleStyle.innerHTML = 'Choose Mouth:'
})
neckButton.addEventListener('click', () => {
    renderButtons(neck)
    removeActive()
    neckButton.classList.add('active')
    titleStyle.innerHTML = 'Choose Neck:'
})
legButton.addEventListener('click', () => {
    renderButtons(leg)
    removeActive()
    legButton.classList.add('active')
    titleStyle.innerHTML = 'Choose Leg:'
})
accButton.addEventListener('click', () => {
    renderButtons(accessories)
    removeActive()
    accButton.classList.add('active')
    titleStyle.innerHTML = 'Choose Accessory:'
})
bgButton.addEventListener('click', () => {
    ...
    titleStyle.innerHTML = 'Choose Background:'
})
